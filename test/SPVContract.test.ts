...
import { parseRawProof } from "./helpers/parse-proof-helpers";
  ...
  describe("#verifyTX", () => {
    describe("#when there are from 1 to 6 transactions in a block", () => {
      ...
      it("should correctly verify when one transaction is in the block", async () => {
        ...
        const [txidReversed, merkleProof, directions] = parseRawProof(txid, rawProof);

        expect(await spvContract.verifyTx(neededBlockData.blockHash, txidReversed, merkleProof, directions)).to.be.true;
      });
      ...
      it("should correctly verify from a block with six transactions", async () => {
        ...
        let [txidReversed, merkleProof, directions] = parseRawProof(txid0, rawProof0);
        ...
        [txidReversed, merkleProof, directions] = parseRawProof(txid1, rawProof1);
        ...
        [txidReversed, merkleProof, directions] = parseRawProof(txid2, rawProof2);
        ...
        [txidReversed, merkleProof, directions] = parseRawProof(txid3, rawProof3);
        ...
        [txidReversed, merkleProof, directions] = parseRawProof(txid4, rawProof4);
        ...
        [txidReversed, merkleProof, directions] = parseRawProof(txid5, rawProof5);
      ...
      it("should correctly return false when the proof is empty", async () => {
        ...
        expect(await spvContract.verifyTx(neededBlockData.blockHash, txid, merkleProof, "0x")).to.be.false;
      });
      ...
      it("should correctly return false when the txid is invalid", async () => {
        ...
        const wrongTxId = "0x0" + txidReversed.slice(3);

        expect(await spvContract.verifyTx(neededBlockData.blockHash, wrongTxId, merkleProof, directions)).to.be.false;
      });
    });
    ...
    it("should verify different transactions from a block with 2 593 transactions", async () => {
      ...
      [txidReversed, merkleProof, directions] = parseRawProof(txid170, rawProof170);
      ...
      [txidReversed, merkleProof, directions] = parseRawProof(txid511, rawProof511);
      ...
      [txidReversed, merkleProof, directions] = parseRawProof(txid1024, rawProof1024);
      ...
      [txidReversed, merkleProof, directions] = parseRawProof(txid1537, rawProof1537);
      ...
      [txidReversed, merkleProof, directions] = parseRawProof(txid1655, rawProof1655);
      ...
      [txidReversed, merkleProof, directions] = parseRawProof(txid2000, rawProof2000);
      ...
      [txidReversed, merkleProof, directions] = parseRawProof(txidLast, rawProofLast);
